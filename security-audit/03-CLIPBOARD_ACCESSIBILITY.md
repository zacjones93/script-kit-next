...
**Description:**
Clipboard history is stored in a plain SQLite database at `~/.kenv/clipboard-history.db` without any encryption. This means:
...
|------------|----------|----------------|-------|
| File System | Yes | ~/.kenv/ directory | Standard user home |
